...
export function Hero() {
	useEffect(() => {
		...
		const stars = document.getElementsByClassName("sparkly-stars") as HTMLCollectionOf<HTMLElement>;
		...
		<div className="h-[50rem] w-full flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-violet-400/[0.4] relative overflow-hidden animate-gridbg">
			...
			<div className="p-4 md:max-w-[69%] mx-5 relative flex items-center justify-between w-full pt-40 md:pt-0">
				<div className="flex flex-col gap-y-2">
					<Link target="_blank" href="https://x.com/faangchahiye">
					...
					<p className="mt-4 font-bold text-neutral-300 max-w-lg text-left ">
						Transform your photos with just one click. Remove the background from any image with our AI-powered tool. Say goodbye to complex editing and hello to{" "}
						<span className="inline-block relative">
							<span className="sparkly-stars star-purple"><Star /></span>
							<span className="sparkly-stars star-pink"><Star /></span>
							<span className="sparkly-stars star-violet"><Star /></span>
